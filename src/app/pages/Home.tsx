      ...
      <div className="max-w-lg mx-auto px-6 py-8">
        <div className={`rounded-3xl shadow-xl overflow-hidden ${darkMode ? 'bg-gray-800' : 'bg-white'} transition-colors`}>
          ...
          <div className="px-6 py-6 relative">
            ...
            <button
              onClick={() => navigate("/camera")}
              className={`w-full mt-3 py-2 flex items-center justify-center gap-2 text-sm transition-colors ${
                darkMode ? 'text-gray-400 hover:text-green-400' : 'text-gray-600 hover:text-[#2D5A27]'
              }`}
            >
              <Camera size={18} />
          ...
          <div className="px-6 pb-6 grid grid-cols-3 gap-3">
            ...
            >
              <div className={`w-16 h-16 rounded-xl shadow-md flex items-center justify-center ${
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div className={`rounded-2xl p-5 shadow-md border ${
            ...
            <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-3 ${
              darkMode ? 'bg-blue-900/30' : 'bg-gradient-to-br from-blue-50 to-blue-100'
            }`}>
          ...
          <div className={`rounded-2xl p-5 shadow-md border ${
            ...
            <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-3 ${
              darkMode ? 'bg-green-900/30' : 'bg-gradient-to-br from-green-50 to-green-100'
            }`}>
          ...
          <div className={`rounded-2xl p-5 shadow-md border ${
            ...
            <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-3 ${
              darkMode ? 'bg-purple-900/30' : 'bg-gradient-to-br from-purple-50 to-purple-100'
            }`}>
          ...
          <div className={`rounded-2xl p-5 shadow-md border ${
            ...
            <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-3 ${
              darkMode ? 'bg-amber-900/30' : 'bg-gradient-to-br from-amber-50 to-amber-100'
            }`}>
